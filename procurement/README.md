...
The microfrontend for procurement in the star wars universe

[![CircleCI](https://circleci.com/gh/react-microfrontends/procurement.svg?style=svg)](https://circleci.com/gh/react-microfrontends/procurement)
...
Go to https://localhost:9001/tp-procurement.js and verify that you are able to load the file without any SSL problems. To solve SSL problems, see [these instructions](https://improveandrepeat.com/2016/09/allowing-self-signed-certificates-on-localhost-with-chrome-and-firefox/).
